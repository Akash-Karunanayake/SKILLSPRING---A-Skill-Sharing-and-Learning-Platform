              ...
              {(post.imageUrl || post.contentURL) && (
                <div className="luxe-side-media">
                  <div className="luxe-media-grid">
                    ...
                    {post.contentURL && (
                      <div className="luxe-video-container">
                        <iframe
        ...
        return (
          <div className="luxe-card">
            ...
            <div className="luxe-card-content">
              ...
              <div className="preview_part luxe-preview-part">
                <div className="preview_part_sub luxe-preview-part-sub">
                  {post.imageUrl && (
                    <img
                      src={`http://localhost:8080/learningPlan/planImages/${post.imageUrl}`}
                      alt={post.title}
                      className="iframe_preview luxe-iframe-preview"
                    />
                  )}
                </div>
                <div className="preview_part_sub luxe-preview-part-sub">
